...
/**
 * The actual recording from a sensor. Having time and sensorNo allows you to
 * uniquely identify a particular 'data', so you can then say: "get me this
 * sensor's reading at this time" Sensor is NOT an attribute of Data because if
 * you have a reference to the sensor inside Data and then the sensor is
 * removed, the reference will point to null and won't give you any information
 */
public class Data {
